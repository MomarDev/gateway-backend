package momar.dev.gateways.controller;

import momar.dev.gateways.domain.Device;
import momar.dev.gateways.repository.DeviceRepository;
import momar.dev.gateways.repository.GatewayRepository;
...
public class GatewayController {
    ...
    @Autowired
    public GatewayController(GatewayRepository gatewayRepository, DeviceRepository deviceRepository) {
    ...
    public Optional<Gateway> getOneGateway(@PathVariable Long gatewayId) {
    ...
    public Page<Device> getAllGatewayDevices(Pageable pageable) {

        return deviceRepository.findAllGateways(pageable);
    }
